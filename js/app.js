...
class DashboardItem {
  ...
  _createMarkup() {
    ...
    <div class="dashboard__item dashboard__item--${id}">
      <article class="tracking-card">
        <header class="tracking-card__header">
          ...
          <img class="tracking-card__menu" src="images/icon-ellipsis.svg" alt="menu icon">
        </header>
        <div class="tracking-card__body">
          <div class="tracking-card__time">
            ${current}hrs
          </div>
          <div class="tracking-card__previous-period">
    ...
    this.prev = this.container.querySelector(
      `.dashboard__item--${id} .tracking-card__previous-period`
    );
  }
